...
import AnimationRevealPage from 'components/Treact/helpers/AnimationRevealPage';
import { Container as ContainerBase } from 'components/Treact/components/misc/Layouts';
import tw from "twin.macro";
import styled from "styled-components";
import {css} from "styled-components/macro"; //eslint-disable-line
import illustration from 'components/Treact/images/login-illustration.svg';
// import logo from 'components/Treact/images/logo.svg';
...
class Login extends React.Component {
  ...
  render(){
    const headingText = 'Log In To Financier'
